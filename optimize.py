...
def objective(trial: optuna.trial.Trial, data_dir: Path, g_workers: int, c_workers: int, epochs: int):
    ...
    try:
        ...
        model = MINA(
            ...
            num_phoneme_heads=num_heads,
            num_phoneme_layers=tf_layers,
            phoneme_feedforward_dim=tf_dim_ff,
            kernel_size=kernel_size,
            conv_dropout=conv_dropout,
            phoneme_dropout=transformer_dropout,
            muon_lr=muon_lr,
            adam_lr=adam_lr,
            weight_decay=weight_decay,
            pos_weight=pos_weight,
            ...
            warmup_steps=warmup_steps,
            do_compile=False,
            phoneme_classifier_dropout=phoneme_dropout,
